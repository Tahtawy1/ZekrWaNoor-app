...
class Tsabih extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _Tsabih();
}

class _Tsabih extends State<Tsabih> {
  int i = 0;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBarForViews(title: 'تسابيح'),
      body: Container(
        color: backgroundColors,
        child: ListView(
          children: [
            Zekr(
              mainZekr: 'سُبْحـانَ اللهِ',
              infoZekr: 'يكتب له ألف حسنة أو يحط عنه ألف خطيئة',
              loopValue: 100,
            ),
            Zekr(
              mainZekr: 'سُبْحـانَ اللهِ وَبِحَمْـدِهِ',
              infoZekr:
            ...
            Zekr(
              mainZekr: 'سُبْحـانَ اللهِ وَالْحَمْدُ لِلَّهِ',
              infoZekr: 'تَمْلَآَنِ مَا بَيْنَ السَّمَاوَاتِ وَالْأَرْضِ',
              loopValue: 100,
            ),
            Zekr(
              mainZekr: 'سُبْحَانَ اللهِ العَظِيمِ وَبِحَمْدِهِ',
              infoZekr: 'غرست له نخلة في الجنة (أى عدد)',
              loopValue: 100,
            ),
            Zekr(
              mainZekr:
                  'سُبْحَانَ اللَّهِ وَبِحَمْدِهِ ، سُبْحَانَ اللَّهِ الْعَظِيمِ ',
              infoZekr: 'ثقيلتان في الميزان حبيبتان إلى الرحمن (أى عدد)',
              loopValue: 100,
            ),
            Zekr(
              mainZekr:
            ...
            Zekr(
              mainZekr: 'الْحَمْدُ للّهِ رَبِّ الْعَالَمِينَ ',
              infoZekr: 'تملأ ميزان العبد بالحسنات',
              loopValue: 100,
            ),
            Zekr(
              mainZekr: 'لا حَوْلَ وَلا قُوَّةَ إِلا بِاللَّهِ',
              infoZekr: 'كنز من كنوز الجنة (أى عدد)',
              loopValue: 100,
            ),
            Zekr(
              mainZekr:
            ...
            Zekr(
              mainZekr: 'أستغفر الله',
              infoZekr: 'لفعل الرسول صلى الله عليه وسلم',
              loopValue: 100,
            ),
            Zekr(
              mainZekr:
            ...
            Zekr(
              mainZekr: 'لَا إِلَهَ إِلَّا اللَّهُ',
              infoZekr: 'أفضل الذكر لا إله إلاّ الله',
              loopValue: 100,
            ),
            Zekr(
              mainZekr: 'الْلَّهُ أَكْبَرُ',
              infoZekr:
