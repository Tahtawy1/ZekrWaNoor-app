...
class Azkarelsabah extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _Azkarelsabah();
}

class _Azkarelsabah extends State<Azkarelsabah> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBarForViews(title: 'أذكار الصباح',),
      body: Container(
        ...
        child: ListView(
          children: [
            ...
            Zekr(
              ...
              infoZekr: 'من قالها حين يصبح أدى شكر يومه',
              loopValue: 1,
            ),
            Zekr(
              mainZekr:
            ...
            Zekr(
              mainZekr: 'أسْتَغْفِرُ اللهَ وَأتُوبُ إلَيْهِ',
              loopValue: 100,
            ),
          ],
        ),
